...
Most results show that it is beneficial to run LDpred2 genome-wide instead of per chromosome, as it was recommended in the first versions of this paper.
[DESCRIBE ALL FIGURES SHOWING THAT] 

Figure \ref{fig:AUC-simu2-ldpred2} shows 

Figure \ref{fig:AUC-real-ldpred2} shows 
...
\begin{table}[ht]
	...
	\begin{tabular}{|c|c|c|c|c|c|c|}
		\hline
		Simulation & Number and location of causal variants & Heritability & Prevalence \\
		\hline
		all\_40\_300 & 300 anywhere on the genome & 40\% & 15\% \\
		all\_40\_3000 & 3000 anywhere on the genome & 40\% & 15\% \\
		all\_40\_30000 & 30,000 anywhere on the genome & 40\% & 15\% \\
		all\_40\_300000 & 300,000 anywhere on the genome & 40\% & 15\% \\
		HLA\_30\_300 & 300 in the HLA region & 30\% & 15\% \\
		HLA\_30\_3000 & 3000 in the HLA region & 30\% & 15\% \\
		both\_40 & 10,000 anywhere on the genome + 300 in the HLA region & 20\% + 20\% & 15\% \\
		\hline
	\end{tabular}
\caption{The seven simulations scenarios. \label{tab:simus}}
\end{table}
...
Let us denote by $\text{SD}_\text{ss}$ the standard deviations derived from the summary statistics (right-hand side of equation \eqref{eq:approx-sd}) and by $\text{SD}_\text{val}$ the standard deviations of genotypes of individuals in the validation set (left-hand side).
