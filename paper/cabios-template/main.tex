...
\author[Priv{\'e} \textit{et~al}.]{Florian Priv\'e,$^{\text{1,}*}$ Julyan Arbel,$^{\text{2}}$ and Bjarni J. Vilhj\'almsson$^{\text{1,3,}*}$}
\address{$^{\text{\sf 1}}$National Centre for Register-Based Research, Aarhus University, Aarhus, 8210, Denmark. \\
$^{\text{\sf 2}}$Univ.\ Grenoble Alpes, Inria, CNRS, Grenoble INP, LJK, Grenoble, 38000, France. \\
$^{\text{\sf 3}}$Bioinformatics Research Centre, Aarhus University, Aarhus, 8000, Denmark.}
...
\abstract{\textbf{Motivation:} Polygenic scores have become a central tool in human genetics research.
...
\textbf{Availability:} LDpred2 is implemented in R package bigsnpr.\\
\textbf{Contacts:} \href{florian.prive.21@gmail.com}{florian.prive.21@gmail.com} and \href{bjv@econ.au.dk}{bjv@econ.au.dk}\\
...
\begin{figure}[htbp]
	\centering
	\includegraphics[width=0.95\linewidth]{AUC-simu}
...
\begin{figure}[htbp]
	\centering
	\includegraphics[width=0.95\linewidth]{AUC-simu2-grid}
...
\begin{figure}[htpb]
	\centering
	\includegraphics[width=0.95\linewidth]{AUC-real}
...
\begin{figure}[htbp]
	\centering
	\includegraphics[width=0.95\linewidth]{AUC-all}
